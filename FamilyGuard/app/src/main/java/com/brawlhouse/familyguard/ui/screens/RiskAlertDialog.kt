...
fun RiskAlertDialog(
            ...
            Column(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Surface(
                        ...
                        shape = RoundedCornerShape(16.dp),
                        border = androidx.compose.foundation.BorderStroke(1.dp, DialogPrimary.copy(alpha = 0.2f))
                    ) {
                        Row(
                            verticalAlignment = Alignment.CenterVertically,
                            modifier = Modifier.padding(horizontal = 8.dp, vertical = 2.dp)
                        ) {
                            Icon(Icons.Filled.Star, contentDescription = null, tint = DialogPrimary, modifier = Modifier.size(14.dp))
                            Spacer(modifier = Modifier.width(4.dp))
                            Text("FATHER", fontSize = 10.sp, fontWeight = FontWeight.Bold, color = DialogPrimary)
                        }
                    }
                ...
                Column(
                    ...
                    Row(verticalAlignment = Alignment.Top) {
                        ...
                        Column {
                            Text("Contact Name", fontSize = 10.sp, color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f))
                            Text("Unknown Caller", fontSize = 14.sp, fontWeight = FontWeight.Bold, color = MaterialTheme.colorScheme.onSurface)
                            Text("+1 (555) 019-2834", fontSize = 12.sp, color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f))
                        }
                    }
                    ...
                    Row(verticalAlignment = Alignment.Top) {
                        Box(
                            ...
                            Icon(Icons.Filled.Security, contentDescription = null, tint = Danger, modifier = Modifier.size(18.dp))
                        }
                        Spacer(modifier = Modifier.width(12.dp))
                        Column {
                            Text("Risk Assessment", fontSize = 10.sp, color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f))
 ...
 // Left border only in HTML, but full border ok
                ...
                Text(
                    ...
                    fontWeight = FontWeight.Medium,
                    color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f),
                    modifier = Modifier.clickable { onAllowClick() }
                )
            }
        }
    }
